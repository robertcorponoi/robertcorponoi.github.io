---
title: Shadertoy to Godot - Night Vision Screen Shaders
slug: godot-night-vision-screen-shaders
date: "2020-07-08"
description: Converting night vision shaders from Shadertoy to Godot to be used as screen shaders
tags: ["godot", "shaders", "game-development"]
---
...
If you would like to see the final results, you can find the GitHub repo [here](https://github.com/robertcorponoi/godot-night-vision-screen-shaders).
...
This first shader is going to consist of a grainy night vision effect with a bit of tunnelling around the edges. The original code for this shader can be found on [Shadertoy](https://www.shadertoy.com/view/Xsl3zf).
...
Below that I've added a couple uniforms so that the fade-in time and noise amount can be adjusted in the inspector or by code. The rest comes down to constants such as `iResolution`, `fragCoord`, `time`, and `fragColor`. `iResolution` is a global in Shadertoy that we have to define and according the Godot docs we can define it as `1.0 / SCREEN_PIXEL_SIZE` or we can pass it in so we just use the first method. The other globals match up to other globals in Godot such as `fragCoord` is `FRAGCOORD`, `time` is `TIME`, and `fragColor` is `COLOR`.
...
![Grainy Night Vision](../../images/jul/godot-night-vision-screen-shaders/night-vision-grainy.png)
...
![Grainy Night Vision Alt](../../images/jul/godot-night-vision-screen-shaders/night-vision-grainy-alt.png)
...
![Blur Line Night Vision](../../images/jul/godot-night-vision-screen-shaders/night-vision-blur-line.png)
...
![Scanlines Night Vision](../../images/jul/godot-night-vision-screen-shaders/night-vision-scanlines.png)
...
![Pixelated Night Vision](../../images/jul/godot-night-vision-screen-shaders/night-vision-pixelated.png)
