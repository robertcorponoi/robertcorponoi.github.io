---
title: Rotating Rigidbodies with PID Controllers
slug: unity-rotating-rigidbodies-with-pid-controllers
date: "2020-07-08"
description: Rotating your Rigidbodies can be a breeze with PID controllers
...
I'd highly recommend checking out the above linked forum post but I'm going to go over the code and expand on it a bit in a more complex example that can also be found on my [Github](https://github.com/robertcorponoi/unity-pid-with-rigidbodies).
...
![Inspector](../../images/jul/rotating-rigidbodies-with-pid-controllers/inspector.png)
## The Gain Values
...
Also check out the [repo](https://github.com/robertcorponoi/unity-pid-with-rigidbodies) for this project for a more complex example.