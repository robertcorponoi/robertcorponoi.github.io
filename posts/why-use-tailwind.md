...
date: "2021-10-28"
description: Tailwind makes it incredibly easy to iterate on the styles for your app with just class names.
---
...
<p className="text-gray-800 dark:text-gray-50">
    I'm dark on light mode and light on dark mode!
</p>
```
